...
public class ExportResultatsController implements Initializable {
    ...
    public void excel_export() {
        ...
        if (onglet_actif.equals("questions")) {
            if (excel_file != null) {
                ...
                HSSFSheet sheet = wb.createSheet("Resultat Vote");
    ...
    public void createDataStudents(HSSFSheet sheet, Integer rowLine){
        HSSFRow rowTitle = sheet.createRow(rowLine);
        
        HSSFCell cellTitle = rowTitle.createCell(0);
        cellTitle.setCellValue("Elève(s) concerné(es)");
        
        HSSFRow rowColumnTitles = sheet.createRow(rowLine + 1);
        
        HSSFCell cellNom = rowTitle.createCell(0);
        cellNom.setCellValue("Nom");
        HSSFCell cellPrenom = rowTitle.createCell(0);
        cellNom.setCellValue("Prenom");
        HSSFCell cellFiliere = rowTitle.createCell(0);
        cellNom.setCellValue("Filiere");
        HSSFCell cellAnee = rowTitle.createCell(0);
        cellNom.setCellValue("Année");
    }
